...
final class CachedExcelTable {
     ...
     */
    private List<DataType> analyzeColumnTypes(final XLSUserSettings settings, final Set<Integer> skippedCols) {
    ...
    private DataTableSpec createSpec(final XLSUserSettings settings, final Set<Integer> skippedCols) {
        ...
        String tableName = settings.getSimpleFilename() + " [" + sheetName + "]";
