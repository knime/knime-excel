...
final class XLSWriter2Settings {
     ...
     */
    XLSWriter2Settings(final DataTableSpec spec) {
        this();
     ...
     */
    XLSWriter2Settings(final NodeSettingsRO settings) throws InvalidSettingsException {
     ...
     */
    final void setWriteColHeader(final boolean writeColHeader) {
     ...
     */
    final void setWriteRowID(final boolean writeRowID) {
     ...
     */
    final void setXCellOffset(final int cellOffset) {
     ...
     */
    final void setYCellOffset(final int cellOffset) {
     ...
     */
    final void setMissingPattern(final String missingPattern) {
     ...
     */
    final String getMissingPattern() {
     ...
     */
    final void setOverwriteOK(final boolean overwriteOK) {
        m_overwriteOK = overwriteOK;
    }

    /** @return the overwrite ok property. */
    final boolean getOverwriteOK() {
     ...
     */
    final void setOpenFile(final boolean openFile) {
        m_openFile = openFile;
    }
     ...
     */
    final boolean getFileMustExist() {
     ...
     */
    final void setDoNotOverwriteSheet(final boolean doNotOverwriteSheet) {
     ...
     */
    final boolean getDoNotOverwriteSheet() {
     ...
     */
    final void setLandscape(final boolean landscape) {
     ...
     */
    final void setAutosize(final boolean autosize) {
        m_autosize = autosize;
    }
     ...
     */
    final void setPaperSize(final short paperSize) {
     ...
     * @since 2.11
     */
    final void setWriteMissingValues(final boolean writeMissingValues) {
     ...
     * @since 2.11
     */
    final boolean getWriteMissingValues() {
     ...
     * @since 3.1.1
     */
    final void setEvaluateFormula(final boolean evaluateFormula) {
