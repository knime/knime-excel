...
/**
 * Reader status message reporter that checks the decryption status of the selected Excel file.
 *
 * @author Manuel Hotz, KNIME GmbH, Konstanz, Germany
 */
public class DecryptionAwareReaderStatusMessageReporter implements StatusMessageReporter {

    private final SettingsModelReaderFileChooser m_model;
     ...
     *
     * @param readerModel reader model to get accessor from
     ...
     */
    public DecryptionAwareReaderStatusMessageReporter(final SettingsModelReaderFileChooser readerModel,
    ...
    public StatusMessage report() throws IOException, InvalidSettingsException {
        try (final var accessor = m_model.createReadPathAccessor()) {
            final var path = accessor.getFSPaths(StatusMessageUtils.NO_OP_CONSUMER).stream().findFirst().orElseThrow();
