 ...
 */
public class ExcelTableReaderNodeFactory2 extends WebUITableReaderNodeFactory<ExcelTableReaderNodeParameters, FSPath, //
        MultiFileSelectionPath, ExcelTableReaderConfig, KNIMECellType, ExcelCell, ExcelMultiTableReadConfig> {

    @SuppressWarnings("javadoc")
    public ExcelTableReaderNodeFactory2() {
