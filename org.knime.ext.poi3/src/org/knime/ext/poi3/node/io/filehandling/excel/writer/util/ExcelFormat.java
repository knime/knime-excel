...
public enum ExcelFormat {
     ...
     */
    public ExcelTableWriter createWriter(final ExcelTableWriterConfig cfg, final ExcelCellWriterFactory cellWriterFactory) {
...
interface TableWriterFunction {
    ...
    ExcelTableWriter createTableWriter(final ExcelTableWriterConfig cfg, final ExcelCellWriterFactory cellWriterFactory);
}
