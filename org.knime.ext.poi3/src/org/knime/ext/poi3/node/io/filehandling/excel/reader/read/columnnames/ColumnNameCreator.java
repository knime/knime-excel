...
/**
 * Interface which provides a method to create a column name.
 *
 * @author Lars Schweikardt, KNIME GmbH, Konstanz
 */
interface ColumnNameCreator {

    /**
     * Creates a column name.
     *
     * @param index the position of the column in the input file
     * @return a column name
     */
    String createColumnName(final int index);
}
