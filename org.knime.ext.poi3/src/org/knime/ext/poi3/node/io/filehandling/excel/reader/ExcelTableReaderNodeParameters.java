 ...
 */
@Migration(ExcelTableReaderMigration.class)
class ExcelTableReaderNodeParameters implements NodeParameters {

    ExcelTableReaderNodeParameters(final NodeParametersInput input) {
        this(input.getURLConfiguration());
    }

    ExcelTableReaderNodeParameters(final NodeCreationConfiguration nodeCreationConfig) {
        this(nodeCreationConfig.getURLConfig());
    }

    private ExcelTableReaderNodeParameters(final Optional<? extends URLConfiguration> urlConfig) { // NOSONAR
        if (urlConfig.isPresent()) {
            m_excelTableReaderParameters = new ExcelTableReaderParameters(urlConfig.get().getUrl());
        }
    }

    ExcelTableReaderNodeParameters() {
        // default constructor
    }

    static final class ExcelTableReaderParametersRef implements ParameterReference<ExcelTableReaderParameters> {
    }
    ...
    static final class ConfigIDSaver extends AbstractConfigIDSaver<ExcelTableReaderParameters> {
    ...
    public void validate() throws InvalidSettingsException {
        m_excelTableReaderParameters.validate();
