...
public interface ExcelTableWriter {
    ...
    /**
     * Writes the {@link RowInput} to an individual sheet. If the number of rows to be written to this sheet exceed the
     * its limitations additional sheets must be created.
     *
     ...
     * @throws IOException - If the table could not be written the excel sheet.
